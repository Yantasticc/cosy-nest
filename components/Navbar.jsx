    ...
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
      ...
      <div className="flex items-center">
        ...
        {/* <div className="hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]">
          <p className="bg-black text-white rounded-full p-2">Domestic</p>
          <p className="p-2">International</p>
        </div> */}
        <div className="px-5">
          <ToggleSwitch />
        </div>
      ...
      <button className="bg-black text-white hidden md:flex items-center py-2 px-2 rounded-full">
        <BsFillJournalBookmarkFill size={20} className="mr-2"/> Bookings
      </button>
